                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        form.reset({
                          ...
                          username: `contractor${timestamp}`,
                          email: `demo.contractor${timestamp}@example.com`, // Use unique email each time
                          ...
                          phone: "9876543210",
                          experience: "4-7",
                          professionalType: "contractor", // This is correctly set to 'contractor'
                          terms: true,
                        });
                        
                        // Make sure isProfessional is set to true for contractor registration
                        console.log("Demo contractor button clicked - setting isProfessional to true");
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        form.reset({
                          ...
                          username: `architect${timestamp}`,
                          email: `demo.architect${timestamp}@example.com`, // Use unique email each time
                        ...
                        // Make sure isProfessional is set to true for architect registration
                        console.log("Demo architect button clicked - setting isProfessional to true");
                      }}
