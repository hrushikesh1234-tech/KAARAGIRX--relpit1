        ...
        <div className="prose max-w-none">
          <section className="mb-6">
            <p className="text-gray-600 mb-4">
              At Kamshet Construction & Architecture Platform, we respect your privacy and are committed to protecting your personal data. This Privacy Policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              ...
              <li><strong>Professional Data</strong> includes professional details like company name, experience, and areas of expertise.</li>
          ...
          <section className="mb-6">
            <h2 className="text-xl font-bold mb-3">How We Collect Information</h2>
            <p className="text-gray-600 mb-4">
              We use different methods to collect data from and about you including through:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li><strong>Direct interactions.</strong> You may give us your information by filling in forms on our site or by corresponding with us by post, phone, email, or otherwise.</li>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li>To register you as a new customer or professional.</li>
